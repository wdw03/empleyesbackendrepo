        ...
        if (!await context.Employees.AnyAsync())
        {
            var employees = new List<Employee>
            {
                new()
                {
                    ...
                    DateOfBirth = DateTime.SpecifyKind(new DateTime(1985, 3, 15), DateTimeKind.Utc), Gender = Gender.Male,
                    ...
                    DateOfJoining = DateTime.SpecifyKind(new DateTime(2020, 1, 10), DateTimeKind.Utc), Salary = 250000,
                ...
                new()
                {
                    ...
                    DateOfBirth = DateTime.SpecifyKind(new DateTime(1990, 7, 22), DateTimeKind.Utc), Gender = Gender.Female,
                    ...
                    DateOfJoining = DateTime.SpecifyKind(new DateTime(2021, 3, 15), DateTimeKind.Utc), Salary = 180000,
                    EmploymentType = EmploymentType.FullTime, Status = EmployeeStatus.Active
                },
                new()
                {
                    ...
                    DateOfBirth = DateTime.SpecifyKind(new DateTime(1988, 11, 5), DateTimeKind.Utc), Gender = Gender.Male,
                    ...
                    DateOfJoining = DateTime.SpecifyKind(new DateTime(2021, 6, 1), DateTimeKind.Utc), Salary = 200000,
                    EmploymentType = EmploymentType.FullTime, Status = EmployeeStatus.Active
                },
                new()
                {
                    ...
                    DateOfBirth = DateTime.SpecifyKind(new DateTime(1995, 4, 18), DateTimeKind.Utc), Gender = Gender.Female,
                    ...
                    DateOfJoining = DateTime.SpecifyKind(new DateTime(2022, 8, 20), DateTimeKind.Utc), Salary = 120000,
                    EmploymentType = EmploymentType.FullTime, Status = EmployeeStatus.Active
                },
                new()
                {
                    ...
                    DateOfBirth = DateTime.SpecifyKind(new DateTime(1992, 9, 30), DateTimeKind.Utc), Gender = Gender.Male,
                    ...
                    DateOfJoining = DateTime.SpecifyKind(new DateTime(2022, 2, 14), DateTimeKind.Utc), Salary = 95000,
                    EmploymentType = EmploymentType.FullTime, Status = EmployeeStatus.Active
                },
                new()
                {
                    ...
                    DateOfBirth = DateTime.SpecifyKind(new DateTime(1993, 12, 8), DateTimeKind.Utc), Gender = Gender.Female,
                    ...
                    DateOfJoining = DateTime.SpecifyKind(new DateTime(2023, 1, 5), DateTimeKind.Utc), Salary = 110000,
                    EmploymentType = EmploymentType.FullTime, Status = EmployeeStatus.Active
                },
                new()
                {
                    ...
                    DateOfBirth = DateTime.SpecifyKind(new DateTime(1991, 6, 25), DateTimeKind.Utc), Gender = Gender.Male,
                    ...
                    DateOfJoining = DateTime.SpecifyKind(new DateTime(2021, 9, 12), DateTimeKind.Utc), Salary = 160000,
                    EmploymentType = EmploymentType.FullTime, Status = EmployeeStatus.Active
                },
                new()
                {
                    ...
                    DateOfBirth = DateTime.SpecifyKind(new DateTime(1997, 2, 14), DateTimeKind.Utc), Gender = Gender.Female,
                    ...
                    DateOfJoining = DateTime.SpecifyKind(new DateTime(2024, 6, 1), DateTimeKind.Utc), Salary = 55000,
                ...
                new()
                {
                    ...
                    DateOfBirth = DateTime.SpecifyKind(new DateTime(1986, 8, 19), DateTimeKind.Utc), Gender = Gender.Male,
                    ...
                    DateOfJoining = DateTime.SpecifyKind(new DateTime(2023, 11, 1), DateTimeKind.Utc), Salary = 130000,
                ...
                new()
                {
                    ...
                    DateOfBirth = DateTime.SpecifyKind(new DateTime(1994, 5, 3), DateTimeKind.Utc), Gender = Gender.Female,
                    ...
                    DateOfJoining = DateTime.SpecifyKind(new DateTime(2023, 4, 17), DateTimeKind.Utc), Salary = 70000,
                ...
                new()
                {
                    ...
                    DateOfBirth = DateTime.SpecifyKind(new DateTime(1989, 1, 28), DateTimeKind.Utc), Gender = Gender.Male,
                    ...
                    DateOfJoining = DateTime.SpecifyKind(new DateTime(2021, 7, 20), DateTimeKind.Utc), Salary = 140000,
                ...
                new()
                {
                    ...
                    DateOfBirth = DateTime.SpecifyKind(new DateTime(1996, 10, 12), DateTimeKind.Utc), Gender = Gender.Female,
                    ...
                    DateOfJoining = DateTime.SpecifyKind(new DateTime(2022, 5, 8), DateTimeKind.Utc), Salary = 85000,
                ...
                new()
                {
                    ...
                    DateOfBirth = DateTime.SpecifyKind(new DateTime(1987, 7, 7), DateTimeKind.Utc), Gender = Gender.Male,
                    ...
                    DateOfJoining = DateTime.SpecifyKind(new DateTime(2020, 11, 3), DateTimeKind.Utc), Salary = 150000,
                ...
                new()
                {
                    ...
                    DateOfBirth = DateTime.SpecifyKind(new DateTime(1998, 3, 21), DateTimeKind.Utc), Gender = Gender.Female,
                ...
                new()
                {
                    ...
                    DateOfBirth = DateTime.SpecifyKind(new DateTime(1993, 11, 15), DateTimeKind.Utc), Gender = Gender.Male,
